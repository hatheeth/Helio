    ...
    <section className="bg-white dark:bg-gray-900 min-h-screen flex items-center justify-center px-6">
      <form onSubmit={handleSubmit} className="w-full max-w-md">
        ...
        <input
          ...
          className="block w-full py-3 pl-3 pr-3 mt-4 border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600"
        />
        ...
        <div className="relative mt-4">
          <input
            ...
            className="block w-full py-3 pl-3 pr-10 border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600"
          />
          <button
            type="button"
